...
class User extends Authenticatable {
 ...
 public function department(){return $this->belongsTo(Department::class);} public function actions(){return $this->hasMany(CorrectiveAction::class,'assignee_id');} public function hseNotifications(){return $this->hasMany(HseNotification::class);}
