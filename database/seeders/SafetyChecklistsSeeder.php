    ...
    public function run(): void
    {
        ...
        DB::transaction(function () use ($checklists, $createdBy): void {
            foreach ($checklists as $data) {
                ...
                if ($checklistId) {
                    // Re-seeding only refreshes the content the seeder owns.
                    // created_at, created_by and is_active (admin-controlled) are left alone.
                    DB::table('checklists')->where('id', $checklistId)->update([
                ...
                foreach ($data['items'] as $sortOrder => $item) {
                    $key = ['checklist_id' => $checklistId, 'sort_order' => $sortOrder];
                    ...
                    if (DB::table('checklist_items')->where($key)->exists()) {
                        DB::table('checklist_items')->where($key)->update($values);
                    } else {
                        // created_at is set only when the row is first created
                        DB::table('checklist_items')->insert($key + $values + ['created_at' => now()]);
                    }
                }

                // Rows left over from an older, longer version of this list are
                // deactivated (never deleted) so existing references stay valid.
                DB::table('checklist_items')
                    ->where('checklist_id', $checklistId)
                    ->where('sort_order', '>=', count($data['items']))
                    ->where('is_active', 1)
        ...
        return array (
          ...
          array (
            ...
            array (
              ...
              3 => 
              array (
                'question' => 'آیا تعداد کپسول‌های موجود کافی است؟',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              36 => 
              array (
                'question' => 'آیا در صورت مشاهده آتش‌سوزی، موارد ذیل به ترتیب انجام می‌شود؟ (به صدا درآوردن آژیر خطر، مطلع کردن واحد آتش‌نشانی)',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              37 => 
              array (
                'question' => 'آیا علائم مخصوص (سیگار نکشید) در کارگاه و اداره در محل‌های لازم نصب گردیده است؟ (در صورت آتش‌سوزی: اعلام به آتش‌نشانی، بستن تمام درها و پنجره‌ها در صورت امکان و خارج شدن از ناحیه یا ساختمان آتش‌گرفته)',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
          ...
          array (
            ...
            array (
              ...
              12 => 
              array (
                'question' => 'آیا اندازه چشمه‌های تور محافظ کوچکتر از ۳۱ سانتی‌متر مربع است؟ و آیا هر ضلع چشمه نیز کوچکتر از ۵۱ سانتی‌متر است؟',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
          ...
          array (
            ...
            array (
              ...
              18 => 
              array (
                'question' => 'آیا فاصله دپوی مصالح حاصل از گودبرداری تا لبه گود حداقل ۲۰ متر و به اندازه کافی است؟',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              27 => 
              array (
                'question' => 'آیا دیوارهای گودبرداری شده با عمق بیش از یک متر بوسیله نصب شمع و مهارها محکم حفاظت می‌گردد؟',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              39 => 
              array (
                'question' => 'آیا در گودبرداری‌های عمیق، در هر ۱۰ متر عمق، در محل ورود و خروج کارگران و یا در پلکان و نردبان دسترسی، پاگردی جهت ایمنی نصب یا احداث شده است؟ و آیا پاگرد نصب شده دارای حفاظ مناسب و مطمئن است؟',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              43 => 
              array (
                'question' => 'آیا نشتی آب زیرزمینی یا نفوذی در دیوارهای گودبرداری شده مشاهده می‌شود؟',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
          ...
          array (
            ...
            array (
              ...
              6 => 
              array (
                'question' => 'فضاهای محدود که ممکن است بخشهای برقدار داشته آیا کارگران استفاده از روشنایی مناسب و حفاظت در هنگام وارد شدن به باشد را به خوبی درک کرده اند؟',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              39 => 
              array (
                'question' => 'لهای فشاری، کلمپ‌ها (گیره‌ها) یا وسایل آیا رسانه‌های اتصال به زمین و قسمت‌های مربوطه توسط جوشکاری اگزوترمیک، اتصا معادل آن اتصال داده شده‌اند؟',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              43 => 
              array (
                'question' => 'آیا تمامی تابلوها و حصارها محکم بسته شده‌اند؟',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              70 => 
              array (
                'question' => 'آیا مسیر عبور کابل‌ها وسیم‌کشی‌ها طوری انتخاب شده‌اند که از آسیب و صدمه فیزیکی به پوشش عایق‌ها جلوگیری به عمل در صورت حرکت و تردد ماشین‌آلات نباشد ( آید)؟',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              71 => 
              array (
                'question' => 'آیا هرگونه تغییر و یا تعویض در سیستم برقی آیا خاکبرداری فقط در محدوده و عمق طراحی‌شده انجام می‌شود؟ (مثال: فقط باید مطمئن بود که از سیم‌کشی که برای روشنایی استفاده می‌گردد برای برق‌رسانی ماشین‌آلات و یا لوازم با توان بالاتر استفاده نشود)؟ آیا قبل از ایجاد هرگونه تغییر و یا تعویض در سیستم برقیتر ازریان برق قطع می‌شود؟',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
          ...
          array (
            ...
            array (
              ...
              17 => 
              array (
                'question' => 'آیا الوارها حداقل ۹۱ میلی‌متر و تا ۷ سانتی‌متر جلوتر از تکیه‌گاه‌ها در جهت طولی روی هم افتادگی دارند و محکم بسته شده‌اند؟ و آیا انتهای الوار با سیم‌های گالوانیزه به ضخامت مناسب امتداد یافته است؟',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              29 => 
              array (
                'question' => 'آیا شرایط روبرو برای فاصله بارهای سنگین برقرار است؟ (۷.۲ متر برای زمین‌های سخت) (۸.۱اید برای زمین‌های نرم) در هر حال فاصله بارهای سنگین نباید از ۱۳ متر تجاوز کند.',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              33 => 
              array (
                'question' => 'آیا مجوز کار برای داربست‌ها وجود دارد؟ و آیا علائم هشداردهنده ایمنی بر روی داربست نصب شده‌اند؟ و آیا از سیستم تگ‌گذاری داربست (Tag) استفاده می‌شود؟',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              36 => 
              array (
                'question' => 'آیا زاویه کوپلینگ (جفت شدن دو عضو) با یکدیگر ۹۰ درجه است؟ (به استثناء بادبندها)',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              42 => 
              array (
                'question' => 'آیا شیب ۷۵ درجه (زاویه نردبان نسبت به سطح افق) در مورد محل استقرار نردبان‌ها رعایت می‌گردد؟',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              54 => 
              array (
                'question' => 'آیا تکیه‌گاه نردبان شیب و یا مکان مناسبی است؟ (از تکیه دادن آن به اجسام شکننده و لغزنده و… خودداری گردد)',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
          ...
          array (
            ...
            array (
              ...
              5 => 
              array (
                'question' => 'آیا اپراتور از تجهیزات ایمنی استفاده می‌کند؟ (کلاه، کفش، کمربند ایمنی)',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              24 => 
              array (
                'question' => 'کنترل رولیک‌ها و غلطک‌ها به لحاظ روانکاری و تنظیم.',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              28 => 
              array (
                'question' => 'کنترل مدار فرمان و مدار قدرت در تابلوی برق دستگاه.',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              29 => 
              array (
                'question' => 'کنترل حفاظ بالای اتاق آسانسور و پوشش تابلو برق بالای اتاق آسانسور.',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
          ...
          array (
            ...
            array (
              ...
              58 => 
              array (
                'question' => 'آیا آلوده نبودن شیر و متعلقات سیلندر به روغن و گریس و غیره رعایت می‌شود؟ (ترجیحاً سیلندرهای اکسیژن)',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
          ...
          array (
            ...
            array (
              ...
              16 => 
              array (
                'question' => 'آیا کاربران دستگاه‌های سنگ ساب و فرز و. دوره‌های آموزشی مناسب را گذرانده‌اند و راهنمای استفاده از این وسایل در اختیارشان قرار گرفته است؟',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
          ...
          array (
            ...
            array (
              ...
              70 => 
              array (
                'question' => 'درصد پیشرفت مهندسی پروژه (طبق شاخص فرایند طراحی و مهندسی) متناسب با هدف تعریف شده است؟ (دلایل انحراف)',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
          ...
          array (
            ...
            array (
              ...
              21 => 
              array (
                'question' => 'آیا خطرات یا بروز احتمالی خطرات مشخص گردیده است؟ آیا جهت پیشگیری از حوادث، وسایل حفاظت فردی مناسب در اختیار کارکنان قرار می‌گیرد؟',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              53 => 
              array (
                'question' => 'آیا مخازن تحت فشار، بست‌ها، شیرها و شیلینگ‌ها تست شده‌اند و طبق مقررات و استاندارد بازرسی و آزمایش می گردند؟',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              59 => 
              array (
                'question' => 'به منظور تقسیم جریان‌های ترافیکی در مسیرهای مورد استفاده مشترک افراد و ماشین‌ها موانع مناسب قرار گرفته است؟',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              108 => 
              array (
                'question' => 'آیا کف آشپزخانه پس از هر ریخت و پز با آب و شوینده‌ها و محلول‌های ضدعفونی، شستشو و ضد عفونی می‌گردد؟',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              154 => 
              array (
                'question' => 'آیا طبقه بندی مواد یخ زده رعایت می‌گردد؟ (به تفکیک گوشت، سبزیجات و غیره)',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              161 => 
              array (
                'question' => 'آیا تمام در و پنجره‌های انبار سالم، قابل شستشو و مجهز به توری و فنر می‌باشد؟',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              163 => 
              array (
                'question' => 'آیا مواد غذایی فاسد نشدنی (حبوبات، سبزیجات و…) در ظروف دردار و به ارتفاع ۲۰ سانتی‌متر از زمین، روی پالت نگهداری می‌شود؟ (نگهداری این مواد به صورت فله‌ای ممنوع است)',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              185 => 
              array (
                'question' => 'چنانچه برای گرم کردن حمام از منابع حرارتی غیر مرکزی استفاده می‌شود. آیا این منابع در محل مناسب قرار دارند؟',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              205 => 
              array (
                'question' => 'آیا تعداد دستشویی‌ها متناسب با تعداد کارکنان می‌باشد؟ برای 1 تا 15 نفر شاغل حداقل 1 دستشویی، برای 16 تا 30 نفر شاغل حداقل 2 دستشویی، برای 31 تا 50 نفر شاغل حداقل 3 دستشویی، برای 51 تا 75 نفر شاغل حداقل 4 دستشویی، برای 76 تا 100 نفر شاغل حداقل 5 دستشویی',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              206 => 
              array (
                'question' => 'آیا محل دستشویی‌ها در مجاورت نمازخانه، غذاخوری و توالت می‌باشد؟',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              230 => 
              array (
                'question' => 'آیا وضعیت آب آشامیدنی از لحاظ امکان آلودگی به عوامل بیولوژیک (قارچ‌ها، انگل‌ها و.) به طور مرتب مورد بازبینی و آزمایش قرار می‌گیرد؟',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              236 => 
              array (
                'question' => 'در صورتی که سیستم تصفیه مناسبی برای فاضلاب‌های بهداشتی وجود ندارد، آیا دفع آن با استفاده از چاه‌های جذبی‌گیرد؟ (آیا قانون ممنوعیت استفاده از چاه‌های جذبی رعایت می‌شود)',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              250 => 
              array (
                'question' => 'نحوه دفع مواد شیمیایی مذکور مشخص است و بر اساس یکی از روش‌های زیر می‌باشد؟ (در گودال‌هایی دفن می‌شود؛ گودال‌ها پوشش مناسبی جهت جلوگیری از آلودگی آب‌های زیرزمینی دارند؛ در مخازنی ذخیره و از محل دور می‌شود؛ سایر روش‌ها)',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
          ...
          array (
            ...
            array (
              ...
              66 => 
              array (
                'question' => 'آیا قرنیزه چوبی به پهنای ۱۵۰ میلی‌متر در قسمت اتصال نرده محافظ به لبه پرتگاه نصب گردیده است؟ (به منظور جلوگیری از سقوط اشیاء از لبه پرتگاه به پایین)',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              69 => 
              array (
                'question' => 'آیا زمین محل استقرار سکو به اندازه کافی سخت می‌باشد و آیا پایه‌های سکوی موقت در زمین فرو نمی‌رود؟',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
          ...
          array (
            ...
            array (
              ...
              56 => 
              array (
                'question' => 'قبل از هر بار استفاده از کمربند ایمنی و طناب مهار کلیه قسمت‌ها و اجزای آن‌ها مورد بازدید و کنترل شخص ذی‌صلاح قرار می‌گیرد.',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              94 => 
              array (
                'question' => 'قسمت‌های مختلف دستگاه‌ها و وسایل بالابر طبق مقررات مربوطه مورد بازدیدهای دوره‌ای با معاینه فنی و آزمایش قرار می‌گیرند.',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              95 => 
              array (
                'question' => 'رانندگان یا متصدیان دستگاه‌ها و وسایل بالابر علاوه بر پروانه مهارت و یا گواهینامه ویژه از مراجع مربوطه از لحاظ جسمی و روانی در سلامت کامل بوده و دارا گواهینامه بهداشتی از مراجع ذی‌ربط می‌باشند',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              106 => 
              array (
                'question' => 'در موقع استفاده از نردبان پایه‌ها و تکیه گاه‌ها در جایی ثابت قرار گرفته تا امکان لغزش وجود نداشته باشد',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
          ...
          array (
            ...
            array (
              ...
              6 => 
              array (
                'question' => 'آیا نماینده یا نمایندگانی از کارگران، پیمانکاران و کارفرمایان در جلسه (HSE) حضور دارند؟',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
          ...
          array (
            ...
            array (
              ...
              35 => 
              array (
                'question' => 'آیا همه روزه حتی مقارن با ایام تعطیل هم، انبار محوطه از نظر ایمنی به وسیله مسئول ایمنی (HSE) به طور دقیق بازدید و نتیجه در دفتر مخصوص ثبت می‌گردد؟',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
              ...
              51 => 
              array (
                'question' => 'آیا علاوه بر درب اصلی درب‌های اضطراری نیز در نظر گرفته شده است؟',
                'guidance' => NULL,
                'weight' => 1,
                'is_critical' => false,
                'is_active' => true,
