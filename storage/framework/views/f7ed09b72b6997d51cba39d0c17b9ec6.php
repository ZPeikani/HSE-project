...
<div class="mb-5 flex items-center justify-between"><div><h2 class="text-xl font-black">برنامه و سوابق بازرسی</h2><p class="mt-1 text-sm text-slate-500">برنامه‌ریزی، اجرا و پایش نتایج بازرسی‌های HSE</p></div><a href="<?php echo e(route('inspections.create')); ?>" class="rounded-xl bg-emerald-600 px-4 py-3 text-sm font-bold text-white">+ برنامه‌ریزی بازرسی</a></div>
