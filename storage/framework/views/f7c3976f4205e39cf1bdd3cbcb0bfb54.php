...
<div class="mb-5 flex items-center justify-between"><div><h2 class="text-xl font-black">دفتر ثبت ریسک</h2><p class="mt-1 text-sm text-slate-500">شناسایی، امتیازدهی و پیگیری کنترل خطرات</p></div><a href="<?php echo e(route('risks.create')); ?>" class="rounded-xl bg-emerald-600 px-4 py-3 text-sm font-bold text-white">+ ثبت خطر جدید</a></div>
