...
<div id="ai-panel" aria-hidden="true">
    ...
    <div id="ai-messages">
        ...
        <div id="ai-suggestions">
            <button class="ai-suggestion" data-text="وضعیت فعلی HSE من/واحد من را بررسی کن و یک خلاصه مدیریتی ارائه بده. تعداد و وضعیت ریسک‌های باز، ریسک‌های زیاد و بحرانی، حوادث اخیر، بازرسی‌های پیش‌رو، اقدامات اصلاحی معوق و نزدیک سررسید، تجهیزات دارای سررسید و اعلان‌های مهم را بررسی کن و مهم‌ترین مواردی که نیاز به اقدام دارند را اولویت‌بندی کن.">وضعیت HSE</button>
            <button class="ai-suggestion" data-text="ریسک‌ها و اقدامات اصلاحی مرتبط با من/واحد من را بررسی کن. ریسک‌های زیاد و بحرانی، اقدامات معوق، اقدامات نزدیک به سررسید و مواردی که اولویت بالاتری برای پیگیری دارند را مشخص کن. برای هر مورد، عنوان، وضعیت، اولویت/سطح ریسک و مهلت انجام را در صورت وجود بیان کن.">ریسک و اقدامات</button>
            <button class="ai-suggestion" data-text="بازرسی‌ها و چک‌لیست‌های مرتبط با من/واحد من را بررسی کن. بازرسی‌های پیش‌رو یا عقب‌افتاده، آخرین نتایج بازرسی، عدم‌انطباق‌های مهم و مواردی که از عدم‌انطباق به ریسک یا اقدام اصلاحی تبدیل شده‌اند را مشخص کن.">بازرسی و چک‌لیست</button>
            <button class="ai-suggestion" data-text="برای سؤال من درباره قوانین و الزامات HSE آماده باش. پاسخ‌ها را بر اساس منابع معتبر موجود در پایگاه دانش سامانه ارائه بده و در صورت وجود، نام منبع، شماره ماده/بند و مرجع مربوطه را ذکر کن. اگر منبع معتبر در پایگاه دانش وجود ندارد، صریحاً اعلام کن و هیچ ماده یا الزام قانونی را حدس نزن.">قوانین HSE</button>
        </div>
    </div>
