...
<div class="min-h-screen lg:grid lg:grid-cols-[270px_1fr]">
 <aside id="main-sidebar" class="fixed inset-y-0 right-0 z-50 flex w-[270px] translate-x-full transform flex-col bg-slate-950 text-white transition-transform duration-300 lg:static lg:z-auto lg:w-auto lg:translate-x-0">
  ...
  @endphp
  <details data-sidebar-category class="group mt-6" {{ $isCoreActive ? 'open' : '' }}><summary class="flex cursor-pointer list-none items-center justify-between px-2.5 pb-1 pt-5 text-lg font-extrabold tracking-wide text-white"><span>پایش و اقدام</span><span class="text-lg text-white transition group-open:rotate-180">⌄</span></summary><div class="space-y-0.5">
  ...
  <details data-sidebar-category class="group mt-6" {{ request()->routeIs('ppe.*') || request()->routeIs('equipment.*') || request()->routeIs('permits.*') ? 'open' : '' }}><summary class="flex cursor-pointer list-none items-center justify-between px-2.5 pb-1 pt-5 text-lg font-extrabold tracking-wide text-white"><span>ایمنی عملیاتی</span><span class="text-lg text-white transition group-open:rotate-180">⌄</span></summary><div class="space-y-0.5">
